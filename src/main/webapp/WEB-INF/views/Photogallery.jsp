...
<!--Navbar-->
	...
	<div class="container">
		...
		<a href="MainHome" class="btn btn-warning navbar-btn navbar-right">Sign out</a>
	...
	<section>
		<div class="container"  style="background-color:#ffffff">
				<h2>  <p class= "login"> Photo Gallery</p> </h2>
				<div class="col-lg-8">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="resources/images/mb1.jpg" alt="Text of the Image">
					</div>
					<div class="item">
						<img src="resources/images/mb2.jpg" alt="Text of the Image">
					</div>
					<div class="item">
						<img src="resources/images/mb3.jpg" alt="Text of the Image">
					</div>
					<div class="item">
						<img src="resources/images/mb1.jpg" alt="Text of the Image">
					</div>
			...
			<div class ="col-lg-4 text-right"></br></br>
				<div class="btn-group-vertical">
					<button type="button" class="btn btn-warning">Add Photos</button> <br/><br/>
					<button type="button" class="btn btn-warning">Delete Photos</button>
				</div>
			</div></center></br>
	</div></br></br>
		</section>
